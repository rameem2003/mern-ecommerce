  ...
  return (
    <header className="p-4 shadow-lg w-full">
      <Flex className="items-center justify-between">
        <Typography variant="h4" className=" text-base font-bold text-black">
          MERN E-commerce
        </Typography>
        ...
        <div className=" hidden">
          ...
          >
            ...
            >
              ...
              <p class="text-slate-800 font-medium ml-2">My Profile</p>
            </li>
            <li
              role="menuitem"
              class="cursor-pointer text-slate-800 flex w-full text-sm items-center rounded-md p-3 transition-all hover:bg-slate-100 focus:bg-slate-100 active:bg-slate-100"
            >
              ...
              <p class="text-slate-800 font-medium ml-2">Edit Profile</p>
            </li>
            <li
              role="menuitem"
              class="cursor-pointer text-slate-800 flex w-full text-sm items-center rounded-md p-3 transition-all hover:bg-slate-100 focus:bg-slate-100 active:bg-slate-100"
            >
              ...
              <p class="text-slate-800 font-medium ml-2">Inbox</p>
            </li>
            <li
              role="menuitem"
              class="cursor-pointer text-slate-800 flex w-full text-sm items-center rounded-md p-3 transition-all hover:bg-slate-100 focus:bg-slate-100 active:bg-slate-100"
            >
              ...
              <p class="text-slate-800 font-medium ml-2">Help</p>
            </li>
